...
//         >
//           Create an account to start booking trusted workers.
//         </motion.p>
//       </section>
...
//           transition={{ duration: 0.8 }}
//           className="max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg border border-[#144272]"
//         >
...
//             </button>
//           </form>
//           <p className="text-center mt-4 text-[#144272]">
...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-[#E6F0FA] to-[#F8FAFC] text-[#0A2647] font-helvetica flex items-center justify-center">
//       <Navbar />
//       <ChatbotWidget />
...
//         animate={{ opacity: 1, scale: 1 }}
//         transition={{ duration: 0.8 }}
//         className="max-w-md w-full p-8 bg-gray-200 rounded-2xl shadow-lg"
//       >
//         <h2 className="text-2xl font-bold text-white mb-6 text-center">Sign Up for MEUN</h2>
